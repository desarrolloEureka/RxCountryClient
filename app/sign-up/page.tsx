            ...
            >
                ...
                <div className="flex flex-col space-y-8 items-center w-full mx-16">
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 justify-center gap-5">
                        ...
                        <div className="col flex md:col-span-2 flex-col w-full space-y-2">
                        ...
                        <div className="col flex flex-col w-full space-y-2">
                            ...
                            {/* <input
                                ...
                                name="phone2"
                                type="tel"
                                className="rounded-xl h-10 bg-transparent text-base border-company-blue border text-white px-4"
                                title="Deben ser números o caracteres telefónicos"
                                pattern="^(\+?)?[0-9\s]+$"
                                onChange={changeHandler}
                            /> */}
                        ...
                        <div className="col flex flex-col w-full space-y-2">
                            <label htmlFor="urlPhoto" className="text-white">
                                Foto de Perfil
                                {/* &nbsp;
                                <span className="text-blue-500">*</span> */}
                            </label>

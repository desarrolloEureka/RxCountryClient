      ...
      <div className='bg-black bg-opacity-60 flex flex-col w-full min-h-screen py-16 px-5 lg:p-16 space-y-16'>
        ...
        >
          ...
          <StepByStep
            ...
            selectChangeHandlerDiagnoses={selectChangeHandlerDiagnoses}
            selectChangeHandlerDiagnostician={selectChangeHandlerDiagnostician}
          ...
          {formStep < 6 && (
            <div
              className={`flex ${
                userRol?.uid === 'ZWb0Zs42lnKOjetXH5lq' && formStep < 6
                  ? 'justify-between'
                  : 'justify-end'

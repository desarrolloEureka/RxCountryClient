                      ...
                      {intraOralsOptions.map((option, index) => {
                        return (
                          ...
                          >
                            <div
                              onClick={() => {
                                if (selectedIntraOrals.includes(option)) {
                                  let selectedList = selectedIntraOrals.filter(
                                    (item) => item !== option
                                  );
                                  setSelectedIntraOrals(selectedList);
                                } else {
                      ...
                      {extraOralsOptions.map((option, index) => {
                        return (
                          ...
                          >
                            <div
                              onClick={() => {
                                if (selectedExtraOrals.includes(option)) {
                                  let selectedList = selectedExtraOrals.filter(
                                    (item) => item !== option
                                  );
                                  setSelectedExtraOrals(selectedList);
                                } else {
                ...
                <div className="grid grid-cols-5 gap-4">
                        ...
                        return (
                          ...
                          >
                            <div
                              ...
                              className={`border border-white rounded-[4px] h-4 w-4 cursor-pointer ${
                                selected3DVolumetricTomography.includes(option)
                                  ? "bg-company-orange"
                                  : "bg-transparent"
                              }`}
                            >
                  ...
                  <div className="col-span-2 flex flex-col space-y-4 p-4 rounded-xl bg-black bg-opacity-50">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {additionalDeliveryMethod.map((option, index) => {
                        return (
                          <div
                            key={index}
                            className="col flex space-x-2 items-center"

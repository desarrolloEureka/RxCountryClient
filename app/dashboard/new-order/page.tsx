...
const NewOrderPage = () => {
    ...
    const clinicalPhotographyDeliveryMethod = ["WEB", "CD"];
                ...
                <div className="flex flex-col rounded-3xl shadow-lg bg-company-gray w-full max-w-[1440px] mx-auto relative">
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-1 gap-2">
                                            <p>
                                                ...
                                                pariatur qui blanditiis unde
                                                sunt a tempora iure cumque
                                                corrupti, maiores beatae
                                        ...
                                        <div className="col-span-1 flex flex-col space-y-4 p-4 rounded-xl bg-black bg-opacity-50">
                                            ...
                                            <div className="grid grid-cols-1 gap-2">
                                                <p>
                                                    ...
                                                    qui blanditiis unde sunt a
                                                    tempora iure cumque
                                                    corrupti, maiores beatae
                                                    explicabo dolores nisi.
                                                    Error a nam possimus.
                                                </p>
                                                <p>
                                                    Lorem ipsum dolor sit amet
                                                    consectetur, adipisicing
                            ...
                            <div className="flex flex-col mx-20">
                                <div className="grid grid-cols-1 gap-4">
                                    <div className="flex flex-col space-y-4 rounded-xl pr-[40%] pb-[20%] pl-[10%] pt-[15%] bg-black bg-opacity-40">
                                        <h2 className="text-company-orange font-bold text-4xl">
                                            La orden #345 ha sido enviada con
                                            éxito al área encargada
                                        </h2>
                    ...
                    {formStep < 6 && (
                        <div className="flex flex-row items-center mt-8 overflow-visible bg-company-blue w-full h-[0.1rem]">
                            <div
                                className={`h-4 w-${formStep}/6 bg-company-ornage ${
                                    formStep < 5
                                        ? "rounded-r-full"
                                        : "rounded-none"
                                }`}

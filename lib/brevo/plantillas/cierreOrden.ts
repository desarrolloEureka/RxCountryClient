export const plantillaCierreOrden = (data: any): string => {
    const plantilla = `
                <!DOCTYPE html>
                <html lang="es">
                    <head>
                    ...
                    <body style="background-color: #e2e8f0;">
                        <div style="max-width: 32rem; margin: 2.5rem auto; background-color: #ffffff; border-radius: 0.5rem; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);">
                            <div style="background-color: #2563eb; color: #ffffff; text-align: center; padding: 1rem; border-top-left-radius: 0.5rem; border-top-right-radius: 0.5rem;">
                                <h1 style="font-size: 1.5rem; font-weight: bold;">Orden Finalizada</h1>
                            </div>
                            <div style="padding: 1.5rem;">
                                ...
                                <p style="margin-top: 1rem; color: #4a5568;">
                                    Nos complace informarte que tu orden ha sido finalizada. A continuación, encontrarás los detalles de tu orden:
                                </p>
                                ...
                                <p style="margin-top: 1rem; color: #4a5568;">
                                    Puedes acceder a tu cuenta para ver más detalles y ver tus resultados.
                                </p>
                                <a href="${data.loginUrl}" style="margin-top: 1.5rem; display: inline-block; background-color: #2563eb; color: #ffffff; padding: 0.5rem 1rem; border-radius: 0.5rem; text-decoration: none;">Iniciar Sesión</a>
                            </div>
